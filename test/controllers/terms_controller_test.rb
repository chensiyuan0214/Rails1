...
class TermsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create term" do
    assert_difference('Term.count') do
      post terms_url, params: { term: { end: @term.end, name: @term.name, start: @term.start, term_id: @term.term_id, type: @term.type } }
    end
  ...
  test "should update term" do
    patch term_url(@term), params: { term: { end: @term.end, name: @term.name, start: @term.start, term_id: @term.term_id, type: @term.type } }

...
class RequirementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create requirement" do
    assert_difference('Requirement.count') do
      post requirements_url, params: { requirement: { long: @requirement.long, requirement_id: @requirement.requirement_id, type: @requirement.type } }
    end
  ...
  test "should update requirement" do
    patch requirement_url(@requirement), params: { requirement: { long: @requirement.long, requirement_id: @requirement.requirement_id, type: @requirement.type } }
